...
public class KhoanChiActivity extends AppCompatActivity {
    ...
    private EditText edtSoTien, edtMoTaChiTieu, edtNgayThang;
    private Button btnLuuChiTieuKhac, btnBack;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnLuuChiTieuKhac.setOnClickListener(v -> {
            ...
            String moTa = edtMoTaChiTieu.getText().toString().trim();
    ...
    private void saveData() {
        ...
        // Lưu tất cả thông tin chi tiêu (bao gồm số tiền, mô tả, ngày tháng)
        ...
        Log.d("KhoanChiActivity", "Data saved: " + stringBuilder.toString());
    }

    private void loadSavedData() {
        // Lấy dữ liệu đã lưu từ SharedPreferences
        String savedData = sharedPreferencesChiTieuKhac.getString(KEY_RESULT, "");
        ...
        if (!savedData.isEmpty()) {
            ...
            Log.d("KhoanChiActivity", "Loaded data: " + savedData);

            // Làm mới giao diện để hiển thị các chi tiêu đã lưu
            refreshLayout();
        } else {
            // Thông báo nếu không có dữ liệu đã lưu
            Log.d("KhoanChiActivity", "No data found in SharedPreferences.");
        }
    }
    ...
    private void refreshLayout() {
        ...
        for (int i = 0; i < thongTinList.size(); i++) {
            ...
            // TextView để hiển thị thông tin chi tiêu
            TextView textView = new TextView(this);
            textView.setText(thongTinList.get(i));  // Hiển thị thông tin chi tiêu (bao gồm số tiền, mô tả, ngày tháng)
